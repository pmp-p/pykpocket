...
/**
 * This example demonstrates how to build a List object and how to access its
 * elements. It creates a python module named "math_utils" and bind a function
 * named "average" to it. It exercises creating a List and accessing its
 * elements. It also demonstrates how to cast a python object to a C++ type.
 */
