...
main ()
{
  ...
  vm->bind (
      employee_module, "love_coding(employee: Dict) -> bool",
  ...
  std::cout << "First name: " << CAST (Str &, first_name)
            << std::endl; // First name: John
  ...
  std::cout << "Last name: " << CAST (Str &, last_name)
            << std::endl; // Last name: Doe
  ...
  std::cout << "Salary: " << CAST (double, salary)
            << std::endl; // Salary: 10000
  ...
  std::cout << "Loves coding: " << CAST (Str &, love_coding)
            << std::endl; // Loves coding: Yes
