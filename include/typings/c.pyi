...
class uchar_p(Pointer[int]):
    pass

class short_p(Pointer[int]):
    pass

class ushort_p(Pointer[int]):
    pass

class int_p(Pointer[int]):
    pass

class uint_p(Pointer[int]):
    pass

class long_p(Pointer[int]):
    pass

class ulong_p(Pointer[int]):
    pass

class longlong_p(Pointer[int]):
    pass

class ulonglong_p(Pointer[int]):
    pass

class float_p(Pointer[float]):
    pass

class double_p(Pointer[float]):
    pass

class bool_p(Pointer[bool]):
    pass
